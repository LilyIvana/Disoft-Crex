...
#End Region
    ...
    Private Sub _PGrabarRegistroDirecto()
        ...
        If _Nuevo Then
            ...
            tokenObtenido = frmBillingDispatch.ObtToken()
            Dim Succes As Integer = Emisor(tokenObtenido, Tb_Id.Text.Trim, 8)
            If Succes = 200 Then

                GrabarTV001(Tb_Id.Text.Trim)

                Dim dtEncabezado As DataTable = L_prObtenerEncabezadoPedido(Tb_Id.Text.Trim)
                ...
                P_ImprimirFactura(Tb_Id.Text.Trim)
            Else
                ToastNotification.Show(Me, "El pedido Nro: " + Tb_Id.Text.Trim + " no pudo ser facturado".ToUpper,
                                   My.Resources.WARNING,
                                   4 * 1000,
                                   eToastGlowColor.Red,
                                   eToastPosition.TopCenter)
        ...
        Try
            ...
            ElseIf codigo = 422 Then
                ...
                If MensajeInicial = "La Factura No" Then
                    ...
                    Dim dt = frmBillingDispatch.ListarFacturas(tokenObtenido, 8.ToString, FechaI, FechaF)
                    If dt.Count > 0 Then
                        ...
                        If Succes = 200 Then
                            L_fnInsertarFacturaAnuladaSifac((Now.Date.ToString("yyyy-MM-dd")), 8, NroFactAnulada, NAutorizacion, "ANULADA")
                        Else
                            L_fnInsertarFacturaAnuladaSifac((Now.Date.ToString("yyyy-MM-dd")), 8, NroFactAnulada, NAutorizacion, "NO ANULADA")
                        End If
                    Else
                        L_fnInsertarFacturaAnuladaSifac((Now.Date.ToString("yyyy-MM-dd")), 8, (NumFactura - 1), 0, "NO ANULADA")
                    End If
