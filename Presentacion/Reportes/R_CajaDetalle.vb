...
Public Class R_CajaDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_CajaDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_CajaDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_CajaDetalle = New R_CajaDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
