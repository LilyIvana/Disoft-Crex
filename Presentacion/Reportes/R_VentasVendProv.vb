...
Public Class R_VentasVendProv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentasVendProv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasVendProv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasVendProv = New R_VentasVendProv()
        rpt.Site = Me.Site
        Return rpt
    End Function
