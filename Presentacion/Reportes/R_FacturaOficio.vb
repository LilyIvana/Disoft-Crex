...
Public Class R_FacturaOficio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FacturaOficio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FacturaOficio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturaOficio = New R_FacturaOficio()
        rpt.Site = Me.Site
        Return rpt
    End Function
