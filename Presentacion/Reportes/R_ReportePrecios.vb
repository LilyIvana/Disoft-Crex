...
Public Class R_ReportePrecios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReportePrecios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReportePrecios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReportePrecios = New R_ReportePrecios()
        rpt.Site = Me.Site
        Return rpt
    End Function
