...
Public Class R_ListaPedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ListaPedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ListaPedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ListaPedidos = New R_ListaPedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
