...
#Region "TC001 Productos"
    ...
    Public Shared Function L_fnProductoGrabar(ByRef numi As String, cod As String, desc As String, desc2 As String,
                                              ...
                                              peso As Integer, prefijo As String, conv2 As Decimal) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@campo1", prefijo))
...
#Region "TO005 Caja"
    ...
    Public Shared Function L_ReporteConsolidadoVentas(numiConci As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 39))
        _listParam.Add(New Datos.DParametro("@olnumiconci", numiConci))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
    ...
    Public Shared Function L_VerificarPedido(numi As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "REPORTE DE VENTAS"
    ...
    Public Shared Function L_prReporteVentasProductos(_fechaI As String, _FechaF As String, almacen As String,
                                                      proveedor As String, producto As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
...
#End Region
    ...
    Public Shared Function L_fnReporteFacturadosV2(FechaI As String, FechaF As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnPedidosLevantadosExcel(Proveedor As Integer, Categoria As Integer, Marca As Integer, Atributo As Integer, Descripcion As String, FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "IMPRESORAS"
    Public Shared Function L_prModificarimpresora(_numi As String, _impresora As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@cbrut", _impresora))
        _listParam.Add(New Datos.DParametro("@cbuact", L_Usuario))

        _Tabla = D_ProcedimientoConParam("sp_Mam_TC0002", _listParam)
        If _Tabla.Rows.Count > 0 Then
            _resultado = True
        Else
            _resultado = False
    ...
    End Function
    Public Shared Function L_prImpresoras() As DataTable
        Dim _Tabla As DataTable
